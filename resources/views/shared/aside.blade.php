<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      @php
        $ventasActive = in_array(Route::currentRouteName(), ['ventas-nueva', 'detalle-venta']);
      @endphp

      @can('ver-ventas')
      <li class="nav-item">
        <a class="nav-link {{ $ventasActive ? '' : 'collapsed' }}" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
        <i class="fa-solid fa-cart-shopping"></i>
        <span>Ventas</span>
        <i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" class="nav-content collapse {{ $ventasActive ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
        <li>
